...
export function ScrollExperience() {
  return (
    <main aria-label="Experiência imersiva Salux inspirada em direção de arte cinematográfica">
      {/* Back link — unobtrusive, top-left */}
      <Link
        to="/"
        className="fixed top-6 left-6 text-white/50 hover:text-white/85 text-xs sm:text-sm tracking-[0.2em] uppercase transition-colors duration-300"
